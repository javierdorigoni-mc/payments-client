...
{
    [Test]
    public async Task CreatePaymentAsync_HttpMessageHandlerReturns200OK_ResultIsSuccessful()
    {
        // Arrange
    ...
    [Test]
    public async Task CreatePaymentAsync_HttpMessageHandlerFails_ResultContainsErrors()
    {
        // Arrange
        var request = FixtureBuilder.Create<CreatePaymentRequest>();
